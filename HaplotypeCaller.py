...
def parse_args():
    ...
    parser.add_argument('-r', default='/n/data1/hms/dbmi/gulhan/lab/REFERENCE/Mouse/mm10_EGFP_mCherry_bwa/mm10_EGFP_mCherry.fa')
    parser.add_argument('-gatk', default='/n/data1/hms/dbmi/gulhan/lab/software/GATK/gatk-4.1.9.0/gatk', help='path to software')
...
def return_slurm_command(args):
    ...
    slurm_command += 'module load gcc java bcftools' + '\n'
