...
def parse_args():
    ...
    parser.add_argument('-out', '--output_path', default='/n/scratch/users/d/dcg18/', help='Path to where the final pipeline output will be written to. Default output will be to /n/data1/hms/dbmi/park/victor/other/.')
    ...
    parser.add_argument('--mail_user', default='asingh46@mgh.harvard.edu', help='slurm job submission option') # set email
    parser.add_argument('-gatk', '--gatk_path', default='/n/data1/hms/dbmi/gulhan/lab/software/GATK/gatk-4.1.9.0/gatk', help='path to software execution script')
    parser.add_argument('-reference', '--reference_path', default='/n/data1/hms/dbmi/gulhan/lab/REFERENCE/b37/Homo_sapiens_assembly19/Homo_sapiens_assembly19.fasta', help='path to reference_path file')
    ...
    parser.add_argument('-picard', default='/n/data1/hms/dbmi/gulhan/lab/software/alon/software/picard.jar')
    parser.add_argument('-csv', help='csv containing matched tumor/normal pairs')
    parser.add_argument('-intervals', default='/n/data1/hms/dbmi/gulhan/lab/ankit/scripts/Haplotypecaller/interval_list.txt')
...
def main(): 
    ...
    os.system('module load gcc python java')
